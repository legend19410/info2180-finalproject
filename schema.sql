...
INSERT INTO `users`(firstname, lastname, `password`,email,date_joined) VALUES ('admin','personell','password123', 'admin@project2.com', NOW());
...
INSERT INTO `issues`(title, `description`, `type`,`priority`, `status`, 
              ...
              VALUES ('Broken Laptop','Laptops tend to have a rather short lifetime. They are outdated
                       ...
                       and by nature they are subject to gradual decay or fatal accidents. Some laptop
                        ...
                        'Bug', 'Major', 'IN PROGRESS', 'David Miller', 'Milton Francis', NOW(), NOW());

INSERT INTO `issues`(title, `description`, `type`,`priority`, `status`, 
                      `assigned_to`, `created_by`, `created`, `updates`) 
              VALUES ('No Semicolon','','Bug', 'Minor', 'OPEN', 'Malik Edwards', 'Milton Francis', NOW(), NOW());

INSERT INTO `issues`(title, `description`, `type`,`priority`, `status`, 
                      `assigned_to`, `created_by`, `created`, `updates`) 
              VALUES ('Broken Laptop','Before doing anything, give your laptop a full look-over and inspection to ensure the screen really needs replacement. If the graphics card on the motherboard is dead, for instance, you may be wasting your time and effort on replacing a perfectly good screen. Additionally, if the laptop has been recently dropped or otherwise possibly physically harmed, you’ll want to double-check for other damage as well.','Bug', 'Major', 'IN PROGRESS', 'Dean Beckford', 'Daley Bailey', NOW(), NOW());

INSERT INTO `issues`(title, `description`, `type`,`priority`, `status`, 
                      `assigned_to`, `created_by`, `created`, `updates`) 
              VALUES ('Forever While Loop','In computer programming, an infinite loop (or endless loop)[1][2] is a sequence of instructions that, as written, will continue endlessly, unless an external intervention occurs ("pull the plug"). It may be intentional.','Proposal', 'Major', 'IN PROGRESS', 'David Miller', 'Milton Francis', NOW(), NOW());

INSERT INTO `issues`(title, `description`, `type`,`priority`, `status`, 
                      `assigned_to`, `created_by`, `created`, `updates`) 
              VALUES ('No Closing Brackets','23

I start out like this {}, then usually fill them with something. Whenever you type {, type a corresponding } and stick it on a new line. The worst thing you have to do in that case is fix indentation prior to committing.','Bug', 'Major', 'IN PROGRESS', 'David Miller', 'Milton Francis', NOW(), NOW());